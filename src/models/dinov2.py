# Implementation from: https://github.com/guojiajeremy/Dinomaly/blob/master/dinov2/models/vision_transformer.py
...
from .dinov2_layers import Mlp, PatchEmbed, SwiGLUFFNFused, MemEffAttention, Block

logger = logging.getLogger("dinov2_layers")
...
def vit_light(patch_size=14, num_register_tokens=0, **kwargs):
    model = DinoVisionTransformer(
        patch_size=patch_size,
        embed_dim=96,
        depth=12,
